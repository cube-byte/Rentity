                ...
                if (response.isSuccessful) {
                    ...
                    if (autos.isEmpty()) {
                        ...
                        val adapter = AutoAdapter(autos) { auto ->
                            ...
                            val prefs = requireActivity().getSharedPreferences("usuario_prefs", android.content.Context.MODE_PRIVATE)
                            ...
                            intent.putExtra("usuario_id",       prefs.getLong("usuario_id", 0L))
                            intent.putExtra("usuario_nombre",   prefs.getString("usuario_nombre", "") ?: "")
                            intent.putExtra("usuario_apellido", prefs.getString("usuario_apellido", "") ?: "")
